...
/*namespace NWUTechTrendsP2_38082918.Controllers
{
...
namespace NWUTechTrendsP2_38082918.Controllers
{
    ...
    public class JobTelemetriesController : ControllerBase
    {
        ...
        // PUT: api/JobTelemetries/5  Modified to check if a Telemetry exists based on the ID parsed in the parameters
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPut("{id}")]
        public async Task<IActionResult> PutJobTelemetry(int id, JobTelemetry jobTelemetry)
        {
        ...
        // DELETE: api/JobTelemetries/5  Modified to check if a Telemetry exists based on the ID parsed in the parameters
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteJobTelemetry(int id)
        {
            if (!JobTelemetryExists(id))
